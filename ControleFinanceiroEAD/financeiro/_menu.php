        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                <li class="text-center">
                    <img src="assets/img/find_user.png" class="user-image img-responsive" alt="Sistema de Controle Financeiro" title="Sistema de Controle Financeiro"/>
                </li>
                <li>
                ...
                <li>
                    <a href="index.php" class="active-menu"><i class="fa fa-power-off fa-2x"></i>Sair</a>
                </li>
            </ul>
        </div>
    </nav>